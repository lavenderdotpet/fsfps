...
sb_v:		.long	0
	...
	.align 4
.globl C(R_Surf8RGBASMStart)
C(R_Surf8RGBASMStart):
...
//----------------------------------------------------------------------
	...
	.align 4
.globl C(R_DrawSurfaceBlock8RGBASM_mip0)
C(R_DrawSurfaceBlock8RGBASM_mip0):
...
//			lightdelta = (lightleft - lightright) & 0xFFFFF;
	...
	leal (%ecx + 2*%ecx),%ecx			// leilei - r_lightwidth * 3
...
//----------------------------------------------------------------------
	...
	.align 4
.globl C(R_DrawSurfaceBlock8RGBASM_mip1)
C(R_DrawSurfaceBlock8RGBASM_mip1):
	pushl	%ebp				// preserve caller's stack frame
	pushl	%edi
	pushl	%esi				// preserve register variables
	pushl	%ebx
...
//----------------------------------------------------------------------
	...
	.align 4
.globl C(R_DrawSurfaceBlock8RGBASM_mip2)
C(R_DrawSurfaceBlock8RGBASM_mip2):
	pushl	%ebp				// preserve caller's stack frame
	pushl	%edi
	pushl	%esi				// preserve register variables
	pushl	%ebx
...
//----------------------------------------------------------------------
	...
	.align 4
.globl C(R_DrawSurfaceBlock8RGBASM_mip3)
C(R_DrawSurfaceBlock8RGBASM_mip3):
	pushl	%ebp				// preserve caller's stack frame
	pushl	%edi
	pushl	%esi				// preserve register variables
	pushl	%ebx
