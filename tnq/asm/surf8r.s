...
//----------------------------------------------------------------------
	...
	.align 4
.globl C(R_DrawSurfaceBlock8RED_mip0)
C(R_DrawSurfaceBlock8RED_mip0):
...
//		{
	...
	movl	%eax,sb_v
	movl	C(prowdestbasered),%edi

	movl	C(pbasesourcered),%esi
...
//----------------------------------------------------------------------
	...
	.align 4
.globl C(R_DrawSurfaceBlock8RED_mip1)
C(R_DrawSurfaceBlock8RED_mip1):
	pushl	%ebp				// preserve caller's stack frame
	pushl	%edi
	pushl	%esi				// preserve register variables
	pushl	%ebx
...
//----------------------------------------------------------------------
	...
	.align 4
.globl C(R_DrawSurfaceBlock8RED_mip2)
C(R_DrawSurfaceBlock8RED_mip2):
	pushl	%ebp				// preserve caller's stack frame
	pushl	%edi
	pushl	%esi				// preserve register variables
	pushl	%ebx
...
//----------------------------------------------------------------------
	...
	.align 4
.globl C(R_DrawSurfaceBlock8RED_mip3)
C(R_DrawSurfaceBlock8RED_mip3):
	pushl	%ebp				// preserve caller's stack frame
	pushl	%edi
	pushl	%esi				// preserve register variables
	pushl	%ebx
...
LPatchTable8:
	...
	.align 4
.globl C(R_Surf8PatchRED)
C(R_Surf8PatchRED):
	pushl	%ebx

	movl	C(host_colormap_red),%eax
