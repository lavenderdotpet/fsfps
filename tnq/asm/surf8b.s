...
//----------------------------------------------------------------------
	...
	.align 4
.globl C(R_DrawSurfaceBlock8BLUE_mip0)
C(R_DrawSurfaceBlock8BLUE_mip0):
...
//		{
	movl	C(r_lightptr_b),%ebx
	movl	C(r_numvblocks),%eax

	movl	%eax,sb_v
	movl	C(prowdestbaseblue),%edi

	movl	C(pbasesourceblue),%esi
...
//----------------------------------------------------------------------
	...
	.align 4
.globl C(R_DrawSurfaceBlock8BLUE_mip1)
C(R_DrawSurfaceBlock8BLUE_mip1):
	pushl	%ebp				// preserve caller's stack frame
	pushl	%edi
	pushl	%esi				// preserve register variables
	pushl	%ebx
...
//----------------------------------------------------------------------
	...
	.align 4
.globl C(R_DrawSurfaceBlock8BLUE_mip2)
C(R_DrawSurfaceBlock8BLUE_mip2):
	pushl	%ebp				// preserve caller's stack frame
	pushl	%edi
	pushl	%esi				// preserve register variables
	pushl	%ebx
...
//----------------------------------------------------------------------
	...
	.align 4
.globl C(R_DrawSurfaceBlock8BLUE_mip3)
C(R_DrawSurfaceBlock8BLUE_mip3):
	pushl	%ebp				// preserve caller's stack frame
	pushl	%edi
	pushl	%esi				// preserve register variables
	pushl	%ebx
...
LPatchTable8:
	...
	.align 4
.globl C(R_Surf8PatchBLUE)
C(R_Surf8PatchBLUE):
	pushl	%ebx

	movl	C(host_colormap_blue),%eax
