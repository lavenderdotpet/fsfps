...
*/
//
// vid_EGA.c: EGA-specific DOS video stuff
//
...
// link together all the EGA modes
	for (i=0 ; i<(NUMVIDMODES - 1) ; i++)
	{
		egavidmodes[i].pnext = &egavidmodes[i+1];
	}

// add the EGA modes at the start of the mode list
