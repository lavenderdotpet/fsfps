...
//
// 2001-12-10 Corrections to compile with LCC
//            renamed "inline"/"outline" to "line_in"/"line_out" as "inline" is a reserverd word
// 2000-07-30 Indirect jmp fix by QuakeForge
//            Source: jmp *Ljmptab(,%eax,4)
//            Old/Wrong: jmp dword ptr[Ljmptab(,%eax,4)]
//            New/Right: jmp dword ptr[Ljmptab+eax*4]
